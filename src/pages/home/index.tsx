      ...
      <div className="mx-[100px] my-[50px]">
        ...
        <div className="flex gap-auto justify-between flex-wrap">
          <div
            ...
            className={`w-[170px] h-[145px] border-2 rounded-md border-slate-400 ${
              category === "phone" ? `bg-red-500 text-white` : ``
            } hover:bg-red-500 hover:text-white cursor-pointer flex flex-col justify-center items-center gap-5`}
          >
          ...
          <div
            ...
            className={`w-[170px] h-[145px] border-2 rounded-md border-slate-400 ${
              category === "computer" ? `bg-red-500 text-white` : ``
            } hover:bg-red-500 hover:text-white cursor-pointer flex flex-col justify-center items-center gap-5`}
          >
          ...
          <div
            ...
            className={`w-[170px] h-[145px] border-2 rounded-md border-slate-400 ${
              category === "camera" ? `bg-red-500 text-white` : ``
            } hover:bg-red-500 hover:text-white cursor-pointer flex flex-col justify-center items-center gap-5`}
          >
          ...
          <div
            ...
            className={`w-[170px] h-[145px] border-2 rounded-md border-slate-400 ${
              category === "smartwatch" ? `bg-red-500 text-white` : ``
            } hover:bg-red-500 hover:text-white cursor-pointer flex flex-col justify-center items-center gap-5`}
          >
          ...
          <div
            ...
            className={`w-[170px] h-[145px] border-2 rounded-md border-slate-400 ${
              category === "television" ? `bg-red-500 text-white` : ``
            } hover:bg-red-500 hover:text-white cursor-pointer flex flex-col justify-center items-center gap-5`}
          >
          ...
          <div
            ...
            className={`w-[170px] h-[145px] border-2 rounded-md border-slate-400 ${
              category === "laptop" ? `bg-red-500 text-white` : ``
            } hover:bg-red-500 hover:text-white cursor-pointer flex flex-col justify-center items-center gap-5`}
          >
        ...
        <div className="flex justify-center">
          ...
          <div>
            <ul className="flex gap-2">
              <li
                className="h-[35px] w-[70px] relative rounded-sm hover:bg-black hover:text-white border-2 border-slate-300 cursor-pointer"
                onClick={prePage}
              >
              ...
              {numbers.map((n: number, i: number) => (
                <li
                  className="h-[35px] w-[35px] relative rounded-sm hover:bg-black hover:text-white border-2 border-slate-300 cursor-pointer"
                  key={i}
